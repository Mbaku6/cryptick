import {
  Avatar, Badge,
  Box, Breadcrumbs as MuiBreadcrumbs, Card, Divider as MuiDivider, Fab, Grid, Link, List,
  ListItem,
  ListItemIcon,
  ListItemText, TextField as MuiTextField,
  Typography
...
function ChatMessageComponent({
  ...
  return (
    <ChatMessage position={position}>
      <ChatMessageInner>
        <ChatMessageAvatar alt="Mubarak bindaina Lavender" src={avatar} />
        ...
        <List>
          <ListItem button>
            <ListItemIcon>
              ...
              >
                <Avatar
                  alt="Mubarak bindaina Lavender"
                  src="/static/img/avatars/avatar-1.jpg"
                />
              </Online>
            </ListItemIcon>
            <ListItemText primary="Mubarak bindaina Lavender" secondary="Sent a photo" />
          </ListItem>
          <ListItem button>
            <ListItemIcon>
              <Online
